...
tape("ungroup single groupby has correct index", function(t){
	t.plan(1);
	var frame = new Frame({
...
tape("ungroup on multiple groupby has correct index", function(t){
	t.plan(1);
	var frame = new Frame({
...
tape("successive ungroup on multiple groupby has correct index", function(t){
	t.plan(1);
	var frame = new Frame({
		"id_0"  : [0, 0, 0, 1, 1, 0, 1, 0, 1],
		"id_1"  : [0, 0, 1, 1, 0, 0, 1, 0, 1],
